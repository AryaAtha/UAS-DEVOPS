    ...
    <div>
      ...
      <div className="relative bg-red-700 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10 pt-24 pb-12 bg-red-700 sm:pt-28 sm:pb-14 md:pt-32 md:pb-16 lg:w-1/2 lg:pt-44 lg:pb-24 xl:pt-48 xl:pb-32">
            <svg
              className="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-red-700 transform translate-x-1/2"
              fill="currentColor"
              viewBox="0 0 100 100"
            ...
            <div className="relative z-20 mx-auto lg:max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-md mx-auto lg:max-w-lg lg:mx-0 lg:text-left">
                ...
                <p className="mt-2 text-red-100 sm:mt-4 lg:mt-6 lg:text-xl">
                  {subheading}
                </p>
      ...
      <Container>
        <div className="flex justify-between items-baseline">
          <SectionHeading>Menu-menu Dapur Malebo</SectionHeading>
          <Link className="text-red-700 underline hover:text-red-800" to="/projects">
            Tampilkan Semua
          </Link>
        </div>
        <div className="mt-8">
